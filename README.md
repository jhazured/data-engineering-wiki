...
| **Direct Lake modes & T5 views** | [`direct-lake-modes-t5-compatibility.md`](fabric/reference/direct-lake-modes-t5-compatibility.md) | 20 min | [`direct-lake-optimization.md`](fabric/optimization/direct-lake-optimization.md), [`architecture-pattern.md`](fabric/architecture/architecture-pattern.md) |
